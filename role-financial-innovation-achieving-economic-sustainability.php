                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-8 offset-sm-2 text-center">
                         ...
                         <div class="title-section">
                            <h1 class="mb-2">Role of Financial Innovation in Achieving  Economic Sustainability: A Review Study </h1>
                        </div>
                     ...
                     <div class="archives mb-3">
                          <span>Role of Financial Innovation in Achieving  Economic Sustainability: A Review Study</span>
                    <p>Ali Meftah Gerged   <sup> 1</sup> </p>
                    <div>TJAF. 2021 November; 1(1): 10-15. Published online 2021 November 10</div>
                    <p style="margin-top: 2px; color:#000 !important;"><strong>doi.org/10.36647/TJAF/01.01.A003</strong></p>
                    <div class="link"> <span><a href="article/impact-unbalanced-diet-causing-hormone-imbalance.pdf" target="_blank">PDF</a></span> </div> 
                      </div>
                 
                    
                 <p> <strong>Abstract:</strong> Financial innovation accelerates the economic sustainability of firms by enhancing financial  markets’ productivity, accelerating capital development, improving financial services, and creating more effective  financial intermediation. This article, therefore, highlights the possible economic performance associated with  applying different methods of financial innovation. Employing a desk study methodology, this paper discusses the  effectiveness of financial innovation techniques in enhancing firms’ economic sustainability performance  theoretically. In doing so, this review paper provides policymakers and practitioners with several insights into the  efficiency of such strategies for businesses’ sustainable economic growth. </p>
          
                   <p> <strong>Abstract:</strong>  Economic Sustainability, Exchanged-traded funds, Financial innovation, Hedge funds, private equity, weather  derivative. </p>
