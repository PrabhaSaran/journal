                        ...
                        <div class="posts-block">
                            ...
                            <div class="slider-news">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li>
                                            <img alt="" src="images/banner-1.jpg" height="290px" />
                                            <div class="slider-caption">
                                                <h2>Technoarete Journal on Accounting and Finance (TJAF)</h2>

                                            </div>
                                        </li>
                                        <li>
                                            <img alt="" src="images/banner-2.jpg" height="290px" />
                                            <div class="slider-caption">
                                                <h2>Technoarete Journal on Accounting and Finance (TJAF)</h2>
                                        ...
                                        <li>
                                            <img alt="" src="images/banner-3.jpg" height="250px" />
                                            <div class="slider-caption">
                                                <h2>Technoarete Journal on Accounting and Finance (TJAF)</h2>
